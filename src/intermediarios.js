...
const validaCamposReq = (req, res, next) => {
...
const existenciaContaQuery = (req, res, next) => {
...
const existenciaContaParams = (req, res, next) => {
...
const existenciaContaBody = (req, res, next) => {
...
module.exports = {
    ...
    validarSenhaQuery,
    existenciaContaBody,
    existenciaContaParams,
    existenciaContaQuery,
